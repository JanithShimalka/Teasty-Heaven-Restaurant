    ...
    <div class="container-scroller">
        ...
        <div class="main-panel">
            <div class="content-wrapper">
                ...
                <div>
                    <form action="{{ url('uploadinv') }}" method="POST" enctype="multipart/form-data">
                        @csrf

                        <div class="mb-3">
                            <label for="date" class="form-label">Date </label>
                            <input type="date" style="color:black" name="date"  required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" style="color:black" name="qty" placeholder="Enter Qty" required>
                        ...
                        <div class="mb-3">
                            ...
                            <select style="color:black" name= "supplier" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" style="color:black" name="exp"  required>
