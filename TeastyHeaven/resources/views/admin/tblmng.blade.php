                        ...
                        <table id="datatable" class="table table-striped table-dark" cellspacing="0" width="100%"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th style="color: white">No. OF PEOPLE</th>
                            ...
                            <tbody>
                                @if (isset($res))
                                    @if (count($res) > 0)
                                        @foreach ($res as $resevation)
                                            <tr>
                                                <td>{{ $resevation->name }}</td>
                                                <td>{{ $resevation->email }}</td>
                                                <td>{{ $resevation->date }}</td>
                                                <td>{{ $resevation->nop }}</td>
                                                <td>{{ $resevation->spr }}</td>
                                                ...
                                                <td>
                                                    ...
                                                    <p>
                                                        ...
                                                        <a type="button" title="Approve"
                                                            href ="{{ url('appoved', $resevation->id) }}"
