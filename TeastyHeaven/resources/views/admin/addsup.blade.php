        ...
        <div class="main-panel">
            <div class="content-wrapper">
                ...
                <div>
                    ...
                    <form action="{{ url('uploadSup') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
                            <label for="menuname" class="form-label">Supplier Name </label>
                            <input type="text" style="color:black" name="supname" placeholder="Enter Supplier Name"
                                required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" style="color:black" name="phone" placeholder="Enter Phone Number"
                                required>

                        </div>
                        <div class="mb-3">
                            <label for="email" class="form-label">Emali </label>
                            <input type="text" style="color:black" name="email" placeholder="Enter Email Address"
                                required>

                        </div>
                        <div class="mb-3">
                            <label for="address" class="form-label">Address </label>
                            <input type="text" style="color:black" name="address" placeholder="Enter Address"
                                required>
