            ...
            <div class="table-rep-plugin">
                <div class="table-responsive b-0" data-pattern="priority-columns">
                    ...
                    <div class="d-flex flex-row-reverse">
                        ...
                        <div class="card " style="width: 120px; padding-left:30px; padding-top:20px; padding-bottom:20px; margin-right:20px" >
                            <h1 class="card-title">Total (Rs) : </h1> {{$total}}
                         </div>
                    </div>

                    <div class="d-flex flex-row-reverse">
                        <a type="button" href="{{url('proceed')}}" class="btn btn-success" style="background-color:#198754; margin-right:20px; margin-top:20px">Proceed</a>
                    </div>
